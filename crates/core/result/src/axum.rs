...
impl IntoResponse for Error {
    fn into_response(self) -> axum::response::Response {
        let status = match self.error_type {
            ...
            ErrorType::TooManyBotCommands => StatusCode::BAD_REQUEST,
            ErrorType::DuplicateCommandName => StatusCode::CONFLICT,
            ErrorType::UnknownInteraction => StatusCode::NOT_FOUND,
            ...
            ErrorType::InsufficientTier { .. } => StatusCode::FORBIDDEN,
            ErrorType::ServerMemberLimitReached { .. } => StatusCode::FORBIDDEN,
            ErrorType::ViewerLimitReached { .. } => StatusCode::FORBIDDEN,
            ErrorType::ClipDailyLimitReached { .. } => StatusCode::FORBIDDEN,
            ErrorType::ClipStorageLimitReached { .. } => StatusCode::FORBIDDEN,
            ErrorType::ClipDurationNotAllowed => StatusCode::FORBIDDEN,
            ErrorType::ClippingNotEnabled => StatusCode::FORBIDDEN,
            ErrorType::BitrateExceedsTier { .. } => StatusCode::FORBIDDEN,

            ErrorType::StripeError { .. } => StatusCode::BAD_GATEWAY,
            ErrorType::AlreadySubscribed => StatusCode::CONFLICT,
            ErrorType::NoActiveSubscription => StatusCode::NOT_FOUND,

            ErrorType::AICompanionBotExists => StatusCode::CONFLICT,
            ErrorType::AICompanionServerLimit { .. } => StatusCode::FORBIDDEN,
            ErrorType::LicenseVerificationFailed { .. } => StatusCode::FORBIDDEN,
            ErrorType::BotMissingEncryptionKey => StatusCode::BAD_REQUEST,
            ErrorType::InvalidPublicKey { .. } => StatusCode::BAD_REQUEST,
            ErrorType::EncryptionKeyNotFound => StatusCode::NOT_FOUND,
            ErrorType::InvitationExpired => StatusCode::GONE,
            ErrorType::EncryptionError { .. } => StatusCode::INTERNAL_SERVER_ERROR,
        };
