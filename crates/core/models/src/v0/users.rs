...
use super::{DecorationEquip, File};
...
auto_derived_partial!(
    ...
    pub struct User {
        ...
        ///
        /// https://docs.rs/revolt-models/latest/company_models/v0/enum.UserBadges.html
        #[cfg_attr(
            feature = "serde",
        ...
        /// Enum of user flags
        ///
        /// https://docs.rs/revolt-models/latest/company_models/v0/enum.UserFlags.html
        #[cfg_attr(
            feature = "serde",
            serde(skip_serializing_if = "crate::if_zero_u32", default)
        )]
...
auto_derived!(
    ...
    pub enum UserBadges {
        /// Company Developer
        Developer = 1,
        /// Helped translate Company
        Translator = 2,
        /// Monetarily supported Company
        Supporter = 4,
    ...
    pub enum SubscriptionTier {
        ...
        #[cfg_attr(feature = "serde", serde(alias = "Premium"))]
        Pro,
