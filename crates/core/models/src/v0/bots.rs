...
auto_derived!(
    ...
    pub struct Bot {
        ...
        /// License type for AI Companion bots
        #[cfg_attr(
            feature = "serde",
            serde(skip_serializing_if = "Option::is_none")
        )]
        pub license_type: Option<String>,
        /// Which server the AI Companion bot has joined (1-server limit)
        #[cfg_attr(
            feature = "serde",
            serde(skip_serializing_if = "Option::is_none")
        )]
        ...
        /// Whether the bot has registered encryption keys
        #[cfg_attr(
            feature = "serde",
            serde(skip_serializing_if = "crate::if_false", default)
        )]
    ...
    pub struct DataCreateBot {
        ...
        pub name: String,
        /// Type of bot to create ("regular" or "ai_companion"), defaults to "regular"
        #[cfg_attr(feature = "serde", serde(default))]
    ...
    pub struct DataEditBot {
        ...
        ///
        /// Must be enabled in order to show up on [Company Discover](https://company.earthservers.net/discover).
    ...
    /// Request to register a bot's RSA public key for E2E encryption
    pub struct DataRegisterPublicKey {
        /// PEM-encoded RSA public key (minimum 2048 bits)
        pub public_key: String,
    }

    /// Response containing an encrypted channel key for a bot
    pub struct EncryptedChannelKeyResponse {
        /// Id of the channel
