...
use company_permissions::{Override, OverrideField};
...
auto_derived!(
    ...
    pub enum Channel {
        ...
        Group {
            ...
            /// Whether this group uses E2E encryption
            #[cfg_attr(
                feature = "serde",
                serde(skip_serializing_if = "crate::if_false", default)
            )]
        ...
        TextChannel {
            ...
            /// Whether this channel uses E2E encryption
            #[cfg_attr(
                feature = "serde",
                serde(skip_serializing_if = "crate::if_false", default)
            )]
    ...
    /// Who can see the viewer list on a public stream
    #[derive(Default)]
    pub enum ViewerListVisibility {
        /// Viewer list hidden from everyone
        #[default]
        Nobody,
        /// Only active participants in the call can see the viewer list
        ParticipantsOnly,
        /// Only users with ManageChannel permission can see the viewer list
        ModeratorsOnly,
        /// Viewer list is public to all channel members
        Everyone,
    }
    ...
    pub struct VoiceInformation {
        ...
        /// Maximum audio bitrate in bps (default: 96000, min: 32000)
        #[cfg_attr(feature = "validator", validate(range(min = 32000)))]
        #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
        pub bitrate: Option<u32>,
        /// Whether this voice channel allows public viewer mode
        #[cfg_attr(feature = "serde", serde(skip_serializing_if = "crate::if_false", default))]
        pub is_stream_public: bool,
        /// Who can see the viewer list when streaming is public
        #[cfg_attr(feature = "serde", serde(default))]
        pub show_viewer_list_to: ViewerListVisibility,
    }
    ...
    pub struct DataEditChannel {
        ...
        /// User IDs to add as group moderators
        pub add_moderators: Option<Vec<String>>,

        /// User IDs to remove from group moderators
        pub remove_moderators: Option<Vec<String>>,
    ...
    pub struct CreateVoiceUserResponse {
        ...
        pub url: String,
        /// Connection type: "participant" or "viewer"
        pub connection_type: String,
    }

    /// Viewer list response
    pub struct ViewersResponse {
        /// Number of viewers currently watching
        pub count: u32,
        /// List of viewer users (None if requester lacks permission to see the list)
        #[cfg_attr(feature = "serde", serde(skip_serializing_if = "Option::is_none"))]
        pub viewers: Option<Vec<super::User>>,
    }
