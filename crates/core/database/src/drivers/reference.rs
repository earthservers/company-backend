...
use crate::{
    AuditLogEntry, Bot, BotCommand, Channel, ChannelCompositeKey, ChannelUnread, Emoji,
    EncryptedChannelInvitation, File, FileHash, Invite, Member, MemberCompositeKey, Message,
    PolicyChange, RatelimitEvent, Report, Server, ServerBan, Snapshot, User, UserSettings, Webhook,
};
...
database_derived!(
    ...
    pub struct ReferenceDb {
        pub bot_commands: Arc<Mutex<HashMap<String, BotCommand>>>,
        ...
        pub audit_log: Arc<Mutex<HashMap<String, AuditLogEntry>>>,
        pub encrypted_channel_invitations: Arc<Mutex<HashMap<String, EncryptedChannelInvitation>>>,
        pub channel_encryption_keys: Arc<Mutex<HashMap<String, String>>>,
    }
);
