...
impl From<crate::Bot> for Bot {
    fn from(value: crate::Bot) -> Self {
        Bot {
            ...
            bot_type: value.bot_type.into(),
            license_type: value.license_type,
            joined_server_id: value.joined_server_id,
            public_key_registered: value.public_key_pem.is_some(),
        }
    }
}
...
impl From<crate::BotType> for BotType {
    fn from(value: crate::BotType) -> Self {
        match value {
            crate::BotType::Regular => BotType::Regular,
            crate::BotType::AiCompanion => BotType::AiCompanion,
        }
    }
}
...
impl From<BotType> for crate::BotType {
    fn from(value: BotType) -> Self {
        match value {
            BotType::Regular => crate::BotType::Regular,
            BotType::AiCompanion => crate::BotType::AiCompanion,
        }
    }
}
...
// BotCommand conversions

impl From<crate::CommandOptionType> for CommandOptionType {
    fn from(value: crate::CommandOptionType) -> Self {
        match value {
            crate::CommandOptionType::String => CommandOptionType::String,
            crate::CommandOptionType::Integer => CommandOptionType::Integer,
            crate::CommandOptionType::Boolean => CommandOptionType::Boolean,
            crate::CommandOptionType::User => CommandOptionType::User,
            crate::CommandOptionType::Channel => CommandOptionType::Channel,
            crate::CommandOptionType::Role => CommandOptionType::Role,
            crate::CommandOptionType::Number => CommandOptionType::Number,
        }
    }
}

impl From<CommandOptionType> for crate::CommandOptionType {
    fn from(value: CommandOptionType) -> Self {
        match value {
            CommandOptionType::String => crate::CommandOptionType::String,
            CommandOptionType::Integer => crate::CommandOptionType::Integer,
            CommandOptionType::Boolean => crate::CommandOptionType::Boolean,
            CommandOptionType::User => crate::CommandOptionType::User,
            CommandOptionType::Channel => crate::CommandOptionType::Channel,
            CommandOptionType::Role => crate::CommandOptionType::Role,
            CommandOptionType::Number => crate::CommandOptionType::Number,
        }
    }
}

impl From<crate::CommandChoice> for CommandChoice {
    fn from(value: crate::CommandChoice) -> Self {
        CommandChoice {
            name: value.name,
            value: value.value,
        }
...
impl From<CommandChoice> for crate::CommandChoice {
...
impl From<crate::CommandOption> for CommandOption {
    fn from(value: crate::CommandOption) -> Self {
        CommandOption {
            name: value.name,
            description: value.description,
            option_type: value.option_type.into(),
            required: value.required,
            choices: value.choices.map(|c| c.into_iter().map(Into::into).collect()),
            autocomplete: value.autocomplete,
        }
    }
}

impl From<CommandOption> for crate::CommandOption {
...
impl From<crate::BotCommand> for BotCommand {
    fn from(value: crate::BotCommand) -> Self {
        BotCommand {
            id: value.id,
            bot_id: value.bot_id,
            name: value.name,
...
impl From<BotCommand> for crate::BotCommand {
    fn from(value: BotCommand) -> Self {
        crate::BotCommand {
            id: value.id,
            bot_id: value.bot_id,
            name: value.name,
        ...
        P: Into<Option<&'a crate::User>>,
    {
        ...
        User {
            ...
            online: can_see_profile
                && company_presence::is_online(&self.id).await
                && !matches!(
                    self.status,
            ...
            relationship,
            subscription: self.subscription.map(|sub| sub.into()),
            active_decorations: self.active_decorations.map(|decs| {
                decs.into_iter().map(|d| d.into()).collect()
            }),
            presence_style: self.presence_style,
            id: self.id,
        }
    }
    ...
    pub async fn into_self(self, force_online: bool) -> User {
        ...
        User {
            ...
            relations: self
                ...
                .unwrap_or_default(),
            badges,
            online: (force_online || company_presence::is_online(&self.id).await)
                && !matches!(
                    self.status,
                    Some(crate::UserStatus {
                        presence: Some(crate::Presence::Invisible),
...
impl From<User> for crate::User {
    fn from(value: User) -> crate::User {
        crate::User {
            ...
            active_decorations: value.active_decorations.map(|decs| {
                decs.into_iter().map(Into::into).collect()
            }),
            presence_style: value.presence_style,
        }
    }
}
...
impl From<ViewerListVisibility> for crate::ViewerListVisibility {
    fn from(value: ViewerListVisibility) -> Self {
        match value {
            ViewerListVisibility::Nobody => crate::ViewerListVisibility::Nobody,
            ViewerListVisibility::ParticipantsOnly => crate::ViewerListVisibility::ParticipantsOnly,
            ViewerListVisibility::ModeratorsOnly => crate::ViewerListVisibility::ModeratorsOnly,
            ViewerListVisibility::Everyone => crate::ViewerListVisibility::Everyone,
        }
    }
}

impl From<crate::ViewerListVisibility> for ViewerListVisibility {
    fn from(value: crate::ViewerListVisibility) -> Self {
        match value {
            crate::ViewerListVisibility::Nobody => ViewerListVisibility::Nobody,
            crate::ViewerListVisibility::ParticipantsOnly => ViewerListVisibility::ParticipantsOnly,
            crate::ViewerListVisibility::ModeratorsOnly => ViewerListVisibility::ModeratorsOnly,
            crate::ViewerListVisibility::Everyone => ViewerListVisibility::Everyone,
        }
    }
}
...
impl From<VoiceInformation> for crate::VoiceInformation {
    fn from(value: VoiceInformation) -> Self {
        crate::VoiceInformation {
            ...
            is_stream_public: value.is_stream_public,
            show_viewer_list_to: value.show_viewer_list_to.into(),
        }
    }
}
...
impl From<crate::UserSubscription> for UserSubscription {
    fn from(value: crate::UserSubscription) -> Self {
        UserSubscription {
...
impl From<UserSubscription> for crate::UserSubscription {
...
impl From<crate::SubscriptionTier> for SubscriptionTier {
    fn from(value: crate::SubscriptionTier) -> Self {
        match value {
            crate::SubscriptionTier::Free => SubscriptionTier::Free,
            crate::SubscriptionTier::Basic => SubscriptionTier::Basic,
            crate::SubscriptionTier::Pro => SubscriptionTier::Pro,
            crate::SubscriptionTier::Ultra => SubscriptionTier::Ultra,
        }
    }
}

impl From<SubscriptionTier> for crate::SubscriptionTier {
    fn from(value: SubscriptionTier) -> Self {
        match value {
            SubscriptionTier::Free => crate::SubscriptionTier::Free,
            SubscriptionTier::Basic => crate::SubscriptionTier::Basic,
            SubscriptionTier::Pro => crate::SubscriptionTier::Pro,
            SubscriptionTier::Ultra => crate::SubscriptionTier::Ultra,
        }
    }
}

impl From<crate::DecorationCategory> for DecorationCategory {
    fn from(value: crate::DecorationCategory) -> Self {
        match value {
            crate::DecorationCategory::AvatarFrame => DecorationCategory::AvatarFrame,
            crate::DecorationCategory::Banner => DecorationCategory::Banner,
            crate::DecorationCategory::Badge => DecorationCategory::Badge,
            crate::DecorationCategory::Nameplate => DecorationCategory::Nameplate,
            crate::DecorationCategory::ChatBubble => DecorationCategory::ChatBubble,
            crate::DecorationCategory::CardSmall => DecorationCategory::CardSmall,
            crate::DecorationCategory::CardLarge => DecorationCategory::CardLarge,
            crate::DecorationCategory::UserPopout => DecorationCategory::UserPopout,
            crate::DecorationCategory::UserPopoutMobile => DecorationCategory::UserPopoutMobile,
            crate::DecorationCategory::ChatBackground => DecorationCategory::ChatBackground,
            crate::DecorationCategory::ChatBackgroundMobile => DecorationCategory::ChatBackgroundMobile,
            crate::DecorationCategory::ProfileModal => DecorationCategory::ProfileModal,
        }
    }
}

impl From<DecorationCategory> for crate::DecorationCategory {
    fn from(value: DecorationCategory) -> Self {
        match value {
            DecorationCategory::AvatarFrame => crate::DecorationCategory::AvatarFrame,
            DecorationCategory::Banner => crate::DecorationCategory::Banner,
            DecorationCategory::Badge => crate::DecorationCategory::Badge,
            DecorationCategory::Nameplate => crate::DecorationCategory::Nameplate,
            DecorationCategory::ChatBubble => crate::DecorationCategory::ChatBubble,
            DecorationCategory::CardSmall => crate::DecorationCategory::CardSmall,
            DecorationCategory::CardLarge => crate::DecorationCategory::CardLarge,
            DecorationCategory::UserPopout => crate::DecorationCategory::UserPopout,
            DecorationCategory::UserPopoutMobile => crate::DecorationCategory::UserPopoutMobile,
            DecorationCategory::ChatBackground => crate::DecorationCategory::ChatBackground,
            DecorationCategory::ChatBackgroundMobile => crate::DecorationCategory::ChatBackgroundMobile,
            DecorationCategory::ProfileModal => crate::DecorationCategory::ProfileModal,
        }
    }
}

impl From<crate::DecorationEquip> for DecorationEquip {
    fn from(value: crate::DecorationEquip) -> Self {
        DecorationEquip {
...
impl From<DecorationEquip> for crate::DecorationEquip {
    fn from(value: DecorationEquip) -> Self {
        crate::DecorationEquip {
            decoration_id: value.decoration_id,
            slot: value.slot.into(),
        }
    }
