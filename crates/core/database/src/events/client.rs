...
use company_result::Error;
use serde::{Deserialize, Serialize};

use company_models::v0::{
    AppendMessage, Channel, ChannelUnread, ChannelVoiceState, Emoji, FieldsChannel, FieldsMember, FieldsMessage, FieldsRole, FieldsServer, FieldsUser, FieldsWebhook, Interaction, Member, MemberCompositeKey, Message, PartialChannel, PartialMember, PartialMessage, PartialRole, PartialServer, PartialUser, PartialUserVoiceState, PartialWebhook, PolicyChange, RemovalIntention, Report, Server, User, UserSettings, UserVoiceState, Webhook
};
...
pub enum EventV1 {
    ...
    /// Viewer count updated for a voice channel
    ViewerCountUpdate {
        id: String,
        count: u32,
    },
    ...
    /// Interaction created (slash command invoked)
