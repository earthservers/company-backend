...
use company_files::{create_thumbnail, decode_image, image_size_vec, is_valid_image, video_size};
use company_models::v0::{Embed, Image, ImageSize, Video};
...
lazy_static! {
    ...
    static ref CLIENT: Client = reqwest::Client::builder()
        ...
        .redirect(redirect::Policy::custom(|attempt| {
            ...
            } else if attempt.url().host_str() == Some("proxy.company.earthservers.net") { // TODO config
                attempt.stop()
            } else {
                attempt.follow()
            }
