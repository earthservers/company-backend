use company_database::{util::reference::Reference, Database, PartialBot, User};
use company_models::v0::{self, DataEditBot};
...
mod test {
    ...
    use company_database::Bot;
    use company_models::v0::{self, FieldsBot};
