use company_database::{Database, User, util::reference::Reference, voice::{VoiceClient, remove_user_from_voice_channels}};
...
mod test {
    ...
    use company_database::{events::client::EventV1, Bot};
