...
use company_permissions::{calculate_channel_permissions, ChannelPermission, Override};
...
pub async fn set_role_permissions(
    ...
    let permissions: company_permissions::PermissionValue = calculate_channel_permissions(&mut query).await;
