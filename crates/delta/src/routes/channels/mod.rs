...
mod analytics_current;
mod analytics_history;
mod channel_ack;
mod channel_delete;
mod channel_edit;
mod channel_fetch;
mod commands_fetch;
mod interaction_invoke;
...
pub fn routes() -> (Vec<Route>, OpenApi) {
    openapi_get_routes_spec![
        ...
        message_purge_before::purge_before,
        ...
        commands_fetch::fetch_channel_commands,
        interaction_invoke::invoke_command,
    ]
}
